...
public class order extends AppCompatActivity {
   /* EditText dealer_mobile, dealer_address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
        ...
        String s2 = MainActivity2.cname .getText().toString() ;
        s2 = s2.replace(".", "_") ;
   ...
   *//*     arrayAdapter_product = new ArrayAdapter<>(order.this, R.layout.spinner_color, product_array);
        ...
        product.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 3) {
                    arrayAdapter_quantity_array_other = new ArrayAdapter<>(order.this, R.layout.spinner_color, pump_hp);
                    arrayAdapter_quantity_array_other.setDropDownViewResource(R.layout.spinner_items);
                }
                else if (position == 4) {
                    arrayAdapter_quantity_array_other = new ArrayAdapter<>(order.this, R.layout.spinner_color , total_quantity);
                    arrayAdapter_quantity_array_other.setDropDownViewResource(R.layout.spinner_items);
                }
                else {
                    arrayAdapter_quantity_array_other = new ArrayAdapter<>(order.this, R.layout.spinner_color, quantity_array);
                    arrayAdapter_quantity_array_other.setDropDownViewResource(R.layout.spinner_items);
                }
     ...
     *//*   arrayadapter_quantity = new ArrayAdapter<>(order.this, R.layout.spinner_color, total_quantity);
        ...
        place_order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mobile.isEmpty()) {
                    ...
                    p = new ProgressDialog(order.this);
                    p.show();
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Dealers Orders").child( dealer_name.getText().toString() ).child(currentDate).updateChildren(pq).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(order.this, ordersubmit.class));
                                finish();
