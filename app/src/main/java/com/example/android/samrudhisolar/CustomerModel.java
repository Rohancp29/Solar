...
public class CustomerModel {
    ...
    public CustomerModel(String dealerid, String dealername, String namecu, String emailcu, String addresscu, String phonecu, String imagecu, String solarcapacity, String systemserialno, String dateofinstall) {
        this.namecu=namecu;
  ...
  /*  public CustomerModel(String namecu, String emailcu, String addresscu, String phonecu, String imagecu) {
         this.namecu=namecu;
         this.emailcu=emailcu;
         this.addresscu=addresscu;
         this.phonecu=phonecu;
